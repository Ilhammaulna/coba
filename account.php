...
<div class="row">
<div class="col-lg-6">
  <span class="logo" style="color:#fff;font-size:20px;padding:5px 0 0 20px;display:block">BINAKARIR || TEST ONLINE</span>
</div>
...
box-shadow:         -1px 11px 24px 0px rgba(50, 50, 50, 0.23);padding:10px 30px 50px;">
  ...
  <p>Berikut ini anda akan disajikan 9 bagian tes. Tiap tes terdiri dari 20 soal dan memiliki waktu pengerjaan yang terbatas.
    Anda diminta untuk mengerjakan dengan cepat dan teliti. Terima Kasih</p>
  <div style="text-align:center;padding-top:10%;">
    <a href="tests.php" class="btn btn-success">Mulai IST Sekarang</a>
    <a href="../papi" class="btn btn-primary">Mulai PAPI KOSTICK Sekarang</a>
  </div>
</div>
<!--home start-->
<?php if(@$_GET['q']==1) {
...
echo  '<div style="display:none" class="panel"><table class="table table-striped title1">
